...
const ADMIN_PASSWORD = 'falisha25'; // Ganti dengan password yang aman
...
async function getMatchesWithTeams(): Promise<Match[]> {
  ...
  return data.map(match => ({ ...match, teams: [match.team1 as Team, match.team2 as Team] })) as Match[];
}
...
const AdminPage: React.FC = () => {
    ...
    return (
        <div className="dark container mx-auto p-4 max-w-4xl">
            ...
            {/* Kotak tes hijau sudah dihapus dari sini */}
